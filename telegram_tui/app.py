"""Main application class for Telegram TUI client."""
...
from .formatting import format_reactions, get_media_label
from .messages import ChatSelected, PaneClicked
from .utils import _log, shorten_urls_in_text, strip_emojis, wrap_text
from .widgets import ChatList, ChatPane, SplitContainer
...
class TelegramApp(App):
    ...
    def __init__(self):
        super().__init__()
        # Get the project root directory (one level up from telegram_tui/)
