...
pub struct Aliases {
    #[serde(flatten)]
    pub map: HashMap<i64, String>, // user_id -> alias
}
...
impl Aliases {
    ...
    pub fn insert(&mut self, user_id: i64, alias: String) {
        self.map.insert(user_id, alias);
    }

    pub fn remove(&mut self, user_id: &i64) -> Option<String> {
